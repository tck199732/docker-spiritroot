...
# export CMAKEVERSION_REQUIRED=cmake-3.11.0
# export CMAKEVERSION=cmake-3.11.2
...
# export MILLEPEDE_LOCATION="https://github.com/ShipSoft/MillepedeII.git"
...
export FLATBUFFERS_BRANCH=v2.0.0
